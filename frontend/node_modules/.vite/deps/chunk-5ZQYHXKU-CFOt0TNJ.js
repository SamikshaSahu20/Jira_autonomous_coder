import { i as log, r as __name, t as select_default } from "./src-C7YXC4Z_.js";
import { R as sanitizeDirective, h as directiveRegex, p as detectType, r as assignWithDepth_default, s as common_default } from "./chunk-CSCIHK7Q-Dki1oNBL.js";
import { B as stepBefore, G as linearClosed_default, H as natural_default, J as Basis, K as basisOpen_default, L as getSymbols, Q as bumpY, R as isPlainObject, U as monotoneX, V as step_default, W as monotoneY, X as noop_default, Y as basis_default, Z as bumpX, a as isArguments, d as isUnsafeProperty, i as isObjectLike, l as isTypedArray, n as isTypedArray$1, nt as linear_default, o as cloneDeep, p as isBuffer, q as basisClosed_default, r as isArrayLikeObject, u as isPrimitive, z as stepAfter } from "./isPrototype-BMRkRDwc.js";
import { t as require_dist } from "./dist-xAXGPef9.js";
...
function mergeWithDeep(target, source, merge, stack) {
	...
	for (let i = 0; i < sourceKeys.length; i++) {
		...
		else if (isObjectLike(targetValue) && isObjectLike(sourceValue) && (isPlainObject(targetValue) || isPlainObject(sourceValue) || isTypedArray$1(targetValue) || isTypedArray$1(sourceValue))) target[key] = mergeWithDeep(targetValue, sourceValue, merge, stack);
		else if (targetValue == null && isPlainObject(sourceValue)) target[key] = mergeWithDeep({}, sourceValue, merge, stack);
		else if (targetValue == null && isTypedArray$1(sourceValue)) target[key] = cloneDeep(sourceValue);
...
//#endregion
export { wrapLabel as _, decodeEntities as a, getEdgeId as c, interpolateToCurve as d, isDetailedError as f, utils_default as g, removeDirectives as h, cleanAndMerge as i, getStylesFromArray as l, random as m, calculateTextHeight as n, encodeEntities as o, parseFontSize as p, calculateTextWidth as r, generateId as s, calculateTextDimensions as t, handleUndefinedAttr as u, catmullRom_default as v, cardinal_default as y };

//# sourceMappingURL=chunk-5ZQYHXKU-CFOt0TNJ.js.map