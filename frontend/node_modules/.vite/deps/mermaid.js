import { a as setLogLevel, i as log, r as __name, t as select_default } from "./src-C7YXC4Z_.js";
import { $ as purify, C as getDiagramLoader, E as getSiteConfig, I as reset, L as sanitizeCss, N as registerDiagram, P as registerLazyLoadedDiagrams, Q as updateSiteConfig, S as getDiagram, T as getEffectiveHtmlLabels, V as saveConfigFromInitialize, W as setConfig, X as styles_default, Z as themes_default, _ as frontMatterRegex, b as getConfig, c as configureSvgSize, g as evaluate, l as cssStyleSheetToString, m as detectors, n as addDirective, p as detectType, q as setSiteConfig, r as assignWithDepth_default, t as UnknownDiagramError, u as defaultConfig } from "./chunk-CSCIHK7Q-Dki1oNBL.js";
import { a as isArguments, f as isArrayLike, n as isTypedArray, p as isBuffer, t as isPrototype } from "./isPrototype-BMRkRDwc.js";
import { a as decodeEntities, f as isDetailedError, g as utils_default, h as removeDirectives, i as cleanAndMerge, o as encodeEntities } from "./chunk-5ZQYHXKU-CFOt0TNJ.js";
import { t as selectSvgElement } from "./chunk-WU5MYG2G-BH6LrVcS.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-XPW4576I-CTZvIVnm.js";
import "./chunk-BSJP7CBP-7YtsMpSP.js";
import "./chunk-L5ZTLDWV-BkQj1-03.js";
import "./chunk-NZK2D7GU-Cef6TATT.js";
import { i as registerIconPacks, o as dedent } from "./chunk-O5CBEL6O-dEqd0XFx.js";
import "./chunk-3OPIFGDE-B4PmPbZC.js";
import "./chunk-KSCS5N6A-CRL0xvAh.js";
import { n as registerLayoutLoaders } from "./chunk-LZXEDZCA-UXPsg2xu.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-AAUBKEIU-D-6P7eNs.js");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-I6XJVG4X-BbKutzoW.js");
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-TEJ5UH35-CWxwLpDX.js");
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-PVQCEYII-BA-bLghp.js");
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-6RSMTGT7-BtrS-p2O.js");
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-5YYISTIA-YkCM6aow.js");
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-4H26LBE5-DL15eQXL.js");
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-W4KKPZXB-coFALfNy.js");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-2RQKCTM6-Cv4zn0fI.js");
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-4Y6WPE33-CLQGdlyN.js");
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-3UESZ5HK-WtIADnVF.js");
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-4FO5ZUOK-D5IWS6aa.js");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-Q7XG4LA2-D9WzsgT_.js");
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-AJRCARHV-CmldwExN.js");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-BHNVJYJU-Dni9M5B9.js");
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-JHISSGLW-CTo6UulV.js");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-PNZ67QCA-DwAWethJ.js");
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-RKZ34NQL-DPhx_BRr.js");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-UN3LZRKU-DT5S2xmX.js");
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-5OEKKPKP-CliQ_K84.js");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-LMA3HP47-DeKM31ZG.js");
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-2AECGRRQ-aeBXCLQs.js");
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-GPEHLZMM-D52pjNbk.js");
		return {
			id: id25,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-5GNKFQAL-BuvLIN6R.js");
		return {
			id: id26,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-3BPJPVTR-Dosm3eQC.js");
		return {
			id: id27,
			diagram: diagram2
		};
...
var detector_default6 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-KO2AKTUF-ws6ZEz1P.js");
		return {
			id: id28,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-YF4QCWOH-CwSfxrvk.js");
		return {
			id: id29,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-CIIHVFJN-D68NLkCA.js");
		return {
			id: id30,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-OG6HWLK6-D3IWGv1b.js");
		return {
			id: id31,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-YWT4CUSO-BLqB39Mc.js");
		return {
			id: id32,
			diagram: diagram2
		};
